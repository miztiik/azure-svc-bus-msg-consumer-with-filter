...
resource r_attach_perms_to_role_appConfigOwner 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('r_attach_perms_to_role_appConfigOwner', r_userManagedIdentity.id, appConfigOwnerRoleId)
